...
megatron_options=" \
        ...
        --eval-iters 10 \
        --save checkpoint/megatron_molbart_100m_seq_checkpoint
        --fp16
"
...
run_cmd="deepspeed --num_nodes ${DLWS_NUM_WORKER} --num_gpus ${DLWS_NUM_GPU_PER_WORKER} megatron_molbart/fine_tune_seq.py $@ ${full_options}"
echo ${run_cmd}
eval ${run_cmd}
