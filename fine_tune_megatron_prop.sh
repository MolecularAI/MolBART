...
megatron_options=" \
        ...
        --eval-iters 10 \
        --save checkpoint/megatron_molbart_100m_prop_checkpoint
        --fp16
"
...
run_cmd="deepspeed --num_nodes ${DLWS_NUM_WORKER} --num_gpus ${DLWS_NUM_GPU_PER_WORKER} megatron_molbart/fine_tune_prop.py $@ ${full_options}"
echo ${run_cmd}
eval ${run_cmd}
